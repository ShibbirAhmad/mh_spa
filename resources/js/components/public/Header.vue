<template>
      ...
      <div class="container flex">
        <div class="header-top-left">
          ...
          <li>
            ...
            <span>09636-203040 (9am-11pm)</span>
          </li>
        </div>
        <div class="header-top-right">
          ...
          <!-- <li>
            ...
            <span> <router-link  target="_blank" :to="{name : 'merchant_login' }" >Merchant</router-link> </span>
          </li>
          <li>
    ...
    <div class="main-header">
      <div class="container flex">
        <div class="main-header-left">
          ...
          <li>
            <router-link to="/">
              <img :src="base_url+'images/static/logo.png'" class="site-logo" alt="" />
            </router-link>
          </li>
          <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="padding: 15px 15px;">
    ...
    <router-link :to="{name:'PasswordEdit'}" class="dropdown-item" href="#">Change Password</router-link><br/><br/>
    <router-link :to="{name:'user_new_password_set'}" class="dropdown-item" href="#">Set New Password</router-link><br/><br/>
    ...
    <a class="dropdown-item" href="#" @click="Logout">Logout</a>
          ...
          <li v-else>
            <router-link style="color:#000;font-size:16px;"  :to="{name:'otpLogin'}">
              <!-- <i class="fa fa-user"></i> -->
              Login/Signup
            </router-link>
          </li>
   ...
   <div class="cart" id="s-cart">
      ...
      <div class="cart-footer">
        <a @click.prevent="goToCheckOut"   class="btn btn-block placebtn" href="#">Place Order | <span> {{ cart.total }}</span></a>
      </div>
      </div>
