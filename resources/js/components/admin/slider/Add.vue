 ...
 ///let image file size check
    ...
    selectPosition() {
      if (this.form.position == 1) {
        ...
        this.image_width = 1360;
        this.image_height = 365;
        this.image_size_text = "Image size must be 1360*365px";
        this.imagae_size=550;
      } else {
        this.form.file = this.$store.state.image_base_link+'images/static/300x365.jpg';
        this.imagae_size=70;
        this.image_size_text = "Image size must be 300*365px";
